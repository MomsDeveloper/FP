module NumberLetterModule exposing (numberLetterModule)
...
numberSeq : Int -> List Int
numberSeq n =
    if n == 0 then
        []

    else
        String.length (numberToWords n) :: numberSeq (n - 1)


numberLetterModule : Int -> Int
numberLetterModule n =
    List.foldl (+) 0 (numberSeq n)
